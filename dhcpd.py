...
# Modified by Ruth Ogunnaike 2016, launches vulnerability scans
#
...
# modified by Ruth Ogunnaike to initiate vulnerability scans using customer scanners
...
import pox.scanserver.ScanInterface as Interface

log = core.getLogger()
whitelist ="pox/firewallpolicies/whitelist.csv"
blacklist = "pox/firewallpolicies/blacklist.csv"
firewallpolicies="pox/firewallpolicies/firewallpolicies.csv"
...
class SimpleAddressPool (AddressPool):
  ...
  """
  def __init__ (self, network = "69.91.3.0/24", first = 1, last = None,
                count = None):
    """
...
def launch (no_flow = False,
            network = "192.168.0.0/24",            # Address range
            first = 12, last = None, count = None, # Address range
            ip = "192.168.0.254",
            router = (),                   # Auto
            dns = ()):                     # Auto
            # network = "192.168.0.0/24",            # Address range
